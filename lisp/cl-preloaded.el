...
;; provide GNU's property-recording definition.  Must be installed
...
;; remacs: `cl--find-class' and its gv setter are unimplemented stubs;
;; provide the property-based implementation GNU uses (class stored on
