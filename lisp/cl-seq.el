...
;; In remacs, `cl-lib' is already provided before this file can be
;; required, so the few cl-lib members used below are inlined here
;; (like the keyword parsing above, this keeps cl-seq self-contained).
