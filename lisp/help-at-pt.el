;;; help-at-pt.el --- local help at point  -*- lexical-binding: t -*-

;; remacs: GNU Emacs 31.1 lisp/help-at-pt.el, verbatim.  The
;; `;;;###autoload' entry points are stubbed from subr-x.el like
;; GNU's loaddefs, so `help-at-pt-kbd-string' & friends resolve
;; without eagerly loading the timer machinery.
