...
;; remacs: `set-advertised-calling-convention' is an unimplemented stub;
;; provide GNU's property-recording definition so the `oclosure-define'
;; and `cl-defun'-family expansions can call it.  Must be installed
;; before the `require's below trigger cl-lib loads that use it.
