...
(require 'url-parse)
;; remacs: mm-decode (Gnus MIME) is not ported; it is only needed via
;; autoload/declare-function below, so make the compile-time require soft.
(eval-when-compile (require 'mm-decode nil t))
