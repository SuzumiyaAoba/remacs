...
;; Ported from GNU Emacs ring.el.  A ring is a (hd-index length . vector)
;; list: insert to, remove from, and rotate it; when full, insertions
;; drop the oldest item.  In `ring-ref', index 0 is the newest element.
;; hd-index is the vector index of the oldest item; newer items follow
;; it, wrapping at the end of the vector.
