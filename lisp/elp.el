...
;; remacs: `cl-defmethod' does not support `:extra' qualifiers or
;; `loadhist-unload-element' methods.  Unload-time un-instrumentation
;; is not available; use `elp-restore-function'/`elp-restore-all'
;; manually before unloading.
