;;; imenu.el --- Mode-specific indexing for current buffer -*- lexical-binding: t -*-
;; Ported from GNU Emacs imenu.el for remacs.

;;; Commentary:

;; This package provides `imenu', `imenu-add-to-menubar', and the
;; index-building machinery used by major modes through
;; `imenu-generic-expression' and `imenu-create-index-function'.
