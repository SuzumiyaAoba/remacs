...
;; Ported from GNU Emacs savehist.el for remacs.

;;; Commentary:

;; This package provides `savehist-mode' which saves minibuffer
;; history (and any additional variables listed in
;; `savehist-additional-variables') to `savehist-file' periodically,
;; on a timer, and when exiting Emacs, and reloads them on the next
;; session.
