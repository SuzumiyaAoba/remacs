...
;; Ported from GNU Emacs saveplace.el for remacs.
...
;; In remacs `cl-lib' is already provided (as in GNU, where it is
;; dumped); the cl-* members used below live in cl-seq, so require it
;; explicitly.
(require 'cl-seq)
