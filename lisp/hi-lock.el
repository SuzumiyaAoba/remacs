...
;; Ported from GNU Emacs hi-lock.el for remacs.
...
(defvar hi-lock-file-patterns-range 10000
...
(defvar hi-lock-highlight-range 2000000
...
(defvar hi-lock-file-patterns-policy 'ask
...
(defvar hi-lock-auto-select-face nil
...
(defvar-local hi-lock-file-patterns nil
  "Patterns found in file for hi-lock mode.")

(defvar-local hi-lock-interactive-patterns nil
  "Patterns provided interactively for hi-lock mode.")

(defvar-local hi-lock-interactive-lighters nil
  "Alist of lighters used interactively for hi-lock mode.")
