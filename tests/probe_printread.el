...
(dolist (s '("(" ")" "(a" "[1" "\"unterm" "#(" "#<" "#z" "?" "?\\z" ",x" "#'"))
  (ignore-errors (read-from-string s)))
(ignore-errors (read-from-string "#! shebang\n42"))
(ignore-errors (read-from-string "#@5abcde 7"))
(ignore-errors (read-from-string "#$"))
(ignore-errors (let ((load-file-name "/tmp/f.el")) (read-from-string "#$")))
(ignore-errors (read-from-string "\"\\x41\\u0042\\U00000043\""))
(ignore-errors (read-from-string "\"\\C-a\\M-b\\^c\""))
(ignore-errors (read-from-string "\"\\a\\b\\d\\e\\f\\s\\v\""))
(ignore-errors (read "?\\x41"))
(ignore-errors (read "?\\u0041"))
(ignore-errors (read "?\\C-?"))
(ignore-errors (read "?\\C-5"))
(ignore-errors (read "?\\M-\\C-a"))
(ignore-errors (read "?\\S-a"))
(ignore-errors (read "?\\H-b"))
(ignore-errors (read "?\\A-c"))
(ignore-errors (read "?\\s-d"))
(ignore-errors (read "#1=[a #1#]"))
(ignore-errors (read "#1=#s(tag x #1#)"))
(ignore-errors (read "#1=(a . #1#)"))
(ignore-errors (read "#2=(x y . #2#)"))
(ignore-errors (eq 1.5 1.5))
(ignore-errors (equal (make-bool-vector 3 t) (make-bool-vector 3 t)))
(ignore-errors (equal (make-bool-vector 3 t) (make-bool-vector 3 nil)))
(ignore-errors (equal #&3"\a" (make-bool-vector 3 t)))
