...
impl Interp {
    ...
    fn define_special_variables(&mut self) {
        ...
        let defs: &[(&str, Value)] = &[
            ...
            ("locale-coding-system", Value::Sym(self.intern("utf-8-unix"))),
            ...
            ("normal-erase-is-backspace", Value::Sym(self.intern("maybe"))),
            ...
            ("buffer-file-coding-system", Value::Sym(self.intern("utf-8-unix"))),
            ...
            ("command-error-function", Value::Sym(self.intern("command-error-default-function"))),
            ...
            ("lisp-indent-function", Value::Sym(self.intern("lisp-indent-function"))),
            ("indent-line-function", Value::Sym(self.intern("indent-relative"))),
            ...
            ("adaptive-fill-first-line-regexp", Value::string("\\`[ \t]*\\'")),
            ...
            ("recenter-positions", Value::list(vec![
            ...
            ("shell-command-default-error-buffer", Value::string("*Shell Command Error*")),
            ("shell-command-prompt-show-cwd", Value::Sym(sym::T)),
            ("exec-suffixes", Value::list(vec![Value::string(".exec"), Value::string(".exe"), Value::string(".com"), Value::string(".bat"), Value::string(".cmd"), Value::string(".btm"), Value::string("")])),
            ...
            ("input-method-verbose-flag", Value::Sym(self.intern("complex-only"))),
            ...
            ("ad-default-compilation-action", Value::Sym(self.intern("maybe"))),
            ...
            ("print-charset-text-property", Value::Sym(self.intern("default"))),
            ...
            ("default-frame-scroll-bars", Value::Sym(self.intern("right"))),
            ...
            ("mouse-1-click-follows-link", Value::Sym(self.intern("double"))),
